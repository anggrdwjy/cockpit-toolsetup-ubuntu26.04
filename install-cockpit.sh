...
echo ""
echo "Fitur yang siap digunakan di dashboard:"
echo "✅ Manajemen Penyimpanan & Jaringan"
echo "✅ Manajemen Virtual Machine (QEMU/KVM) -> Menu 'Virtual Machines'"
echo "✅ Manajemen Kontainer (Podman)         -> Menu 'Podman Containers'"
echo "=================================================================="
